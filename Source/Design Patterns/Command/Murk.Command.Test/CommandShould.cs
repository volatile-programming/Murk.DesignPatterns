...
using System;
using MurkCommand = Murk.Command.Command;
...
namespace Murk.Test.Command
{
	...
	public class CommandShould
	{
		...
		public void TestInitialize()
		{
			...
			_sut = new MurkCommand(_actionToExecute);
		}
		...
		public void Constructor_GuardsAgainstNull()
		{
			Assert.ThrowsException<ArgumentNullException>(
				() => new MurkCommand(null));
		}

		[TestMethod]
		public void ConstructHimself()
		{
			_ = new MurkCommand(_actionToExecute);
		}
		#endregion
